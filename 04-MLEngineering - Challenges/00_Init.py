...
# MAGIC %sql
# MAGIC USE CATALOG barbara_lakehouse;
# MAGIC
# MAGIC CREATE DATABASE IF NOT EXISTS barbara_lakehouse.ml_sandbox;
...
file_path = f"/Volumes/barbara_lakehouse/ml_sandbox/data/train.csv"
